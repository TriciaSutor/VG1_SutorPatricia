    ...
    public class Ship : MonoBehaviour
    {
        ...
        public void UpgradeHull() {
            ...
            if(GameController.instance.money >= cost) {
                ...
                hullUpgradeText.text = "Hull Upgrade $" + Mathf.RoundToInt(healthMax);
            }
        }

        public void UpgradeFireSpeed() {
            int cost = 100 + Mathf.RoundToInt((1f - firingDelay) * 100);
            ...
            if(GameController.instance.money >= cost) {
                ...
                int newCost = 100 + Mathf.RoundToInt((1f - firingDelay) * 100);
